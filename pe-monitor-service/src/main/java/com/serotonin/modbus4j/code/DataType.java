...
public class DataType {
	...
	public static final int UINT32_SWAPPED = 6;// 柴发
	public static final int INT32_SWAPPED = 7;
	public static final int FLOAT32 = 8;// EPM600K UPS
	public static final int FLOAT32_SWAPPED = 9;// 柴发
	public static final int FLOAT32_SWAPPED_INVERTED = 21;
	public static final int STR = 18;
	public static final int UINT8 = 32;
	public static final int UINT8_LOWER = 32;
	public static final int UINT8_HIGH = 33;
	...
	/** Constant <code>ONE_BYTE_INT_UNSIGNED_LOWER=32</code> */
	public static final int ONE_BYTE_INT_LOWER = 34;
	/** Constant <code>ONE_BYTE_INT_UNSIGNED_UPPER=33</code> */
	public static final int ONE_BYTE_INT_UPPER = 35;
	
	public static final int BYTES = 45;
	
	public static final int REG = 46;
	
	/**
	 * BBAADDCC  2143
	 */
	public static final int  FOUR_BYTE_INT_CF = 55;
	public static final int  INT32_2143 = 55;
	public static final int  INT32_CF = 55;
	...
	private static void initCmdCache() {
		try {
			Field[] fields = DataType.class.getDeclaredFields();
			for (Field field : fields) {
				try {
					Object object = field.get(DataType.class);
					if (object instanceof Integer) {
						DATA_TYPE_MAP.put(field.getName().toUpperCase(), (Integer) object);
					}
	...
	public static final Integer getDataType(String dt) {
		if(dt==null) {
			return null;
		}
		return DATA_TYPE_MAP.get(dt.toUpperCase());
	}
}
